...
<link href="<c:url value='/style/fontawesome-free-5.14.0-web/css/fontawesome.min.css'/>" rel="stylesheet"/>
<link href="<c:url value='/style/fontawesome-free-5.14.0-web/css/solid.min.css'/>" rel="stylesheet"/>
